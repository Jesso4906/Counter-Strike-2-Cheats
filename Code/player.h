...
const uintptr_t entityListOffset = 0x1B5C6C8; // offset from client.dll; accessed in  client.dll at \x40\x53\x48\x83\xEC\x20\x4C\x8B\x41\x10\x48\x8B\xDA + 20
const uintptr_t localPlayerOffset = 0x1889F20; // offset from client.dll; accessed in client.dll at \x48\x39\xBE\x80\x01\x00\x00
