...
const uintptr_t inMatchOffset = 0x17B7F98; // offset from client.dll

const uintptr_t entityListOffset = 0x19B4998; // offset from client.dll; accessed at \x48\x81\xEC\x20\x01\x00\x00\x0F\x29\x70\xB8 + 0x37
const unsigned int playerNameOffset = 0x630;
const unsigned int pawnHandleOffset = 0x7DC;
const int maxPlayerCount = 64;

const uintptr_t localPlayerOffset = 0x181A998; // offset from client.dll

const uintptr_t localPlayerViewAnglesOffset = 0x5ECC08; // offset from engine2.dll
